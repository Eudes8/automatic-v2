...
// socket.io-client removed in example to avoid build-time dependency during typecheck
...
export default function SocketDemo() {
  ...
  useEffect(() => {
    // WebSocket connection with socket.io would go here
    // Disabled for build-time typecheck
